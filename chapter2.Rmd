...
** Note: I failed to knit the .Rmd file with the code (due to some unexpected error). However, please refer to my IODS for my original (and functioning) R code: https://github.com/roopekaaronen/IODS-project/blob/master/data/create_learning2014.R **
...
![**Diagnostics of Simple Linear Model**](C:\Users\RoopeOK\Documents\GitHub\IODS-project\Assumptions.png)
